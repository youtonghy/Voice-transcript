(function () {
  ...
  const translations = {
    en: {
      ...
      'index.context.optimize': 'Optimize Wording',
      'index.optimized.pending': 'Optimizing...',
      'index.optimized.failed': 'Optimization failed',
      'index.optimized.label': 'Optimized',
      'index.optimized.noText': 'Transcription is not ready; cannot optimize yet',
      'index.optimized.logQueued': 'Requested optimization',
      'index.optimized.logFailed': 'Optimization failed',
      'index.optimized.timeout': 'Optimization timed out',
    ...
    zh: {
      ...
      'index.context.optimize': '优化语句',
      'index.optimized.pending': '优化中...',
      'index.optimized.failed': '优化失败',
      'index.optimized.label': '优化结果',
      'index.optimized.noText': '转写尚未完成，无法优化',
      'index.optimized.logQueued': '已提交优化请求',
      'index.optimized.logFailed': '优化失败',
      'index.optimized.timeout': '优化超时',
